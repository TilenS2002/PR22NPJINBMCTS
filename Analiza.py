...
selected_features = ['VzrokNesrece', 'TipNesrece', 'Starost', 'Spol', 'Drzavljanstvo', 'PoskodbaUdelezenca']
...
X_encoded = pd.get_dummies(X, columns=['VzrokNesrece', 'TipNesrece', 'Spol', 'Drzavljanstvo', 'PoskodbaUdelezenca'])

#Razdelitev testne in učne
